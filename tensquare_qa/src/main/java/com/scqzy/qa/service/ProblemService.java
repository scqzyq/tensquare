...
public class ProblemService {
    ...
    public PageResult<Problem> newList(String labelId, int page, int size) {
        ...
        return new PageResult<>(problemPage.getTotalElements(), problemPage.getContent(), problemPage.getTotalPages());
    }
    ...
    public PageResult<Problem> waitList(String labelId, int page, int size) {
        Pageable pageable = PageRequest.of(page - 1, size);
